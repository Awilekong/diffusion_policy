...
# ===============================================
# Franka 训练启动脚本 - Image Only (无State输入)
# ===============================================
# 实验: 测试仅使用图像观测，不使用state输入的效果
# ===============================================

# 配置
SESSION_NAME="train_image_only"
EXP_NAME="image_only_no_state"
DEVICE="cuda:4"  # 使用空闲GPU
...
echo -e "${BLUE}======================================${NC}"
echo -e "${BLUE}  Franka 训练启动器 - Image Only${NC}"
echo -e "${BLUE}======================================${NC}"
echo ""
...
echo -e "${RED}use_state_input: False${NC} (仅使用图像观测)"
echo ""
...
tmux send-keys -t ${SESSION_NAME} "    policy.obs_encoder.use_state_input=False \\" C-m
...
echo "  • policy.obs_encoder.use_state_input=False"
echo "  • 仅使用图像观测（camera_0, camera_1, camera_2）"
echo "  • 特征维度: 3×512 = 1536D (vs 1543D with state)"
echo ""
echo -e "${BLUE}======================================${NC}"
echo -e "${BLUE}  使用说明${NC}"
echo -e "${BLUE}======================================${NC}"
